...
export class PersonServiceAdapter extends GeneralServiceAdapter<PersonModel, PersonCreateDto, PersonUpdateDto, PersonModelView> implements GetAvailableCanSeePort<PersonModelView> {
    constructor(
        @Inject(PERSON_REPOSITORY) private readonly personRepository: GeneralRepositoryPort<PersonModel> & GenerateModelViewPort<PersonModel, PersonModelView> & GetAvailableCanSeePort<PersonModelView>,
